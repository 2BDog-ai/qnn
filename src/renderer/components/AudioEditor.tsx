    ...
    <div className="min-h-full h-full flex flex-col bg-gray-50">
      <div className="flex-1 max-w-7xl mx-auto w-full p-3 min-h-0">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 h-full flex flex-col overflow-hidden">
          <div className="border-b border-gray-200 px-4 py-2">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3 min-w-0">
                <CutIcon className="w-5 h-5 text-blue-600 flex-none" />
                <div className="min-w-0">
                  <h2 className="text-lg font-semibold text-gray-900">音频剪辑</h2>
                  <p className="text-xs text-gray-500 truncate">剪辑输出为 MP3</p>
                </div>
              </div>
              <button
                onClick={loadAudioFile}
                disabled={isLoading || isProcessing}
                className="px-3 py-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 flex items-center gap-2 text-sm transition-colors"
              >
          ...
          {audioFile && (
            <div className="border-b border-gray-200 bg-gray-50 px-3 py-1.5 space-y-1">
              <div className="flex flex-wrap items-center gap-2">
                <button
                  onClick={togglePlayback}
                  className="p-1.5 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex-none"
                ...
                <button
                  ...
                  disabled={!selection}
                  className="px-3 py-1.5 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-40 text-sm transition-colors flex-none"
                >
                  试听选区
                </button>

                <div className="flex-1 min-w-[280px] bg-white rounded-lg border border-gray-200 px-3 py-1.5">
                  ...
                  <div
                    ref={progressRef}
                    className="relative h-4 bg-gradient-to-r from-gray-100 to-gray-200 rounded-full cursor-pointer group shadow-inner touch-none"
                  ...
                  >
                    ...
                    />
                    <div
                      className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-4 h-4 bg-white border-2 border-blue-500 rounded-full shadow-lg cursor-grab active:cursor-grabbing z-10"
                ...
                <div className="flex items-center gap-2 px-2 py-1 bg-white rounded-lg border border-gray-200 flex-none">
                  ...
                  <input
                    ...
                    className="w-16"
                  />
                  <span className="text-sm text-gray-600 min-w-[2.75rem]">{Math.round(volume * 100)}%</span>
                </div>
                ...
                {originalMusicId && (
                  <button
                    ...
                    disabled={!canTrim}
                    className="px-2.5 py-1 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:opacity-40 text-sm flex items-center gap-2 transition-colors flex-none"
                  >
                ...
                <button
                  ...
                  disabled={!canTrim}
                  className="px-2.5 py-1 bg-purple-600 text-white rounded-lg hover:bg-purple-700 disabled:opacity-40 text-sm flex items-center gap-2 transition-colors flex-none"
                >
                ...
                <button
                  ...
                  disabled={!selection}
                  className="px-2.5 py-1 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 disabled:opacity-40 text-sm transition-colors flex-none"
                >
                  清除选区
                </button>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-0.5 text-xs">
                <span className="text-gray-600 truncate max-w-[38rem]">文件：<span className="font-medium text-gray-900">{audioFile.name}</span></span>
              ...
              <div className="flex flex-wrap items-center gap-2 bg-white rounded-lg border border-gray-200 px-2.5 py-1.5">
                <span className="text-sm font-medium text-gray-700 mr-1">精确时间</span>
                ...
                <input
                  ...
                  className="w-12 px-1.5 py-0.5 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
                ...
                <input
                  ...
                  className="w-12 px-1.5 py-0.5 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
                <span className="text-sm text-gray-600 ml-2">结束</span>
                <input
                  type="number"
                  min={0}
                  step={1}
                ...
                <button
                  ...
                  className="px-3 py-0.5 bg-blue-600 text-white rounded text-sm hover:bg-blue-700 transition-colors"
                >
                  应用选区
                </button>
                <button
                  ...
                  className="px-3 py-0.5 bg-gray-200 text-gray-700 rounded text-sm hover:bg-gray-300 transition-colors"
                >
                  清空
                </button>
                <span className="text-xs text-gray-500 ml-auto">总时长：{formatTime(duration)}</span>
              </div>
